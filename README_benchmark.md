...
Total input tokens, total generated tokens, end-to-end latency, TTFT, TPOT, mean running batch size(average scheduled batch size in decode steps) are obtained via step 1. Summarization latency is obtained in step2. Other metrics are calculated as the following:
